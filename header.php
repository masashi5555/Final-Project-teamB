        ...
        <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: blue">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $baseName.'index.php';?>" aria-current="page">Index</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $baseName.'/sales_manager.php';?>" aria-current="page">Sales by Manager</a>
                    </li>
                    <li class="nav-item">
